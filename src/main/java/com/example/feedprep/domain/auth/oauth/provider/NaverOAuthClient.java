...
public class NaverOAuthClient implements OAuthClient {
    ...
    public String getAuthorizationUrl(String role) {
        ProviderConfig prop = oAuthProperties.getProviders().get(OAuthProvider.NAVER);
    ...
    public OAuthUserResponseDto getUserInfo(String accessToken) {
        ProviderConfig config = oAuthProperties.getProviders().get(OAuthProvider.NAVER);
        ...
        return OAuthUserResponseDto.builder()
                .providerId(String.valueOf(responseData.get("id")))
